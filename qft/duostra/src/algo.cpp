...
unordered_map<size_t, vector<size_t>> Topology::gate_by_generation(
    ...
    for (auto pair : map) {
        size_t gate_id = pair.first;
        size_t generation = pair.second;

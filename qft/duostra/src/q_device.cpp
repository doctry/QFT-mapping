...
device::Device::Device(std::fstream &file, unsigned r, unsigned s) : _R_CYCLE(r), _SWAP_CYCLE(s)
{
    unsigned num;
    file >> num;
...
device::Device::Device(std::vector<std::vector<unsigned>> &adj_lists, unsigned r, unsigned s) : _R_CYCLE(r), _SWAP_CYCLE(s)
{

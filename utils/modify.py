...
def main(args):
    ...
    conf["mapper"]["greedy_conf"]["exec_single"]= False if args.exec_single=="false" else True
    f.close()
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--exec_single", type=str, help="execute single-qubit gate directly", default="false")

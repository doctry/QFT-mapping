...
result_f=result_nonexec_5.log
time_f=time_nonexec_5.log

echo "Results to benchmarks" > $result_f
echo "Running times to benchmarks" > $time_f

for name in 9symml_195 cycle10_2_110 inc_237 rd53_251 sqrt8_260 adr4_197 dc2_222 life_238 rd73_252 square_root_7 cm42a_207 dist_223 mlp4_245 rd84_253 urf1_149 cm82a_208 ham15_107 pm1_249 root_255 urf1_278 cm85a_209 hwb8_113 qft_10 sqn_258 urf2_277 z4_268; do
